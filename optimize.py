...
def parse_args():
    ...
    # LLM parameter
    parser.add_argument("--opt-model", type=str, default="gpt-4.1", help="Model for optimization")
    parser.add_argument("--opt-temp", type=float, default=0.7, help="Temperature for optimization")
    parser.add_argument("--eval-model", type=str, default="gpt-4.1", help="Model for evaluation")
    parser.add_argument("--eval-temp", type=float, default=0.3, help="Temperature for evaluation")
    parser.add_argument("--exec-model", type=str, default="gpt-4.1", help="Model for execution")
    ...
    parser.add_argument("--max-rounds", type=int, default=3, help="Maximum number of rounds")
